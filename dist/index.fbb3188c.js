...
inputDate.setAttribute("min", _dateFns.format(new Date(), "yyyy-MM-dd"));
let outputElement = document.querySelector(".output__text");
button.onclick = countdown;
function countdown() {
    let todayDate = Date.now();
    let inputValue = inputDate.value;
    let resultObject = _dateFns.intervalToDuration({
        start: new Date(todayDate),
        end: new Date(inputValue)
    });
    let result = _dateFns.formatDuration(resultObject, {
        format: [
            'years',
            'days',
            'hours'
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gZD5H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../locale/en-US/index.js":"8XKCq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hNtu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/toInteger/index.js":"f7kKX","../addMonths/index.js":"hES3W","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aIdiY","bDbGG"], "bDbGG", "parcelRequire4482")
